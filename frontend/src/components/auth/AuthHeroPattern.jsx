// Generates the grid background for light and dark themes
...
// Fades the grid towards the edges in dark mode
const darkGridMask =
...
export function AuthHeroPattern() {
  return (
    <>
      ...
      {/* Horizontal fade overlay (Dark Mode) */}
      <div
        aria-hidden
      ...
      {/* Vertical fade overlay (Dark Mode) */}
      <div
        aria-hidden
      ...
      {/* Grid pattern with radial mask (Dark Mode) */}
      <div
        aria-hidden
